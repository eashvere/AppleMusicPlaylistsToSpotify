...
<button
  on:click={() => {
    location.href = spotifyAuthLink;
  }}
  type="button"
  class=" bg-black hover:bg-green-500 text-white font-bold py-3 px-5 rounded-md inline-flex items-center"
>
  <svg
    ...
    /></svg
  >
  <span class="ml-2">Log In to Spotify</span>
</button>
